...
import { getUserCollection } from "@/controller/collection";
  ...
  return (
    <div className="p-4 w-full container-child text-white">
      <div className="flex flex-col lg:flex-row gap-4 lg:gap-0 lg:items-center lg:justify-between mb-6">
        <p className="text-xl lg:text-2xl font-bold">Your Collection</p>
        {collection.length > 0 && (
          <input
            type="text"
            value={searchQuery}
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        {collection.length > 0 ? (
          filteredCollection.length > 0 ? (
            ...
            <div className="flex flex-1 justify-center items-center h-[20rem]">
              <p className="text-gray-400 text-center">
                No collection match your search. <br />
          ...
          <div className="flex flex-1 justify-center items-center h-[20rem]">
            <p className="text-gray-400 text-center">
              Your item collection is empty! <br />
